// Hand-written "golden" SystemVerilog model of ooo_cpu_ref.ivy at stage 3a: the
...
// (ooo_cpu_ref.il) with rtlil_eqv:
//
//     ./check_ooo_golden.sh ooo_cpu_ref ooo_mem_golden.sv
//
