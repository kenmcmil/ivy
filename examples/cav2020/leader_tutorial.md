...
this command:
    ...
    $ ivy_check isolate=abstract_model trace=true leader_tutorial_without_proof.ivy
...
this command:
    ...
    $ ivy_check isolate=id leader_tutorial.ivy
...
We can ask Ivy to do the verification like this:
    ...
    $ ivy_check isolate=leader leader_tutorial.ivy
...
and execute the following commands:
    ...
    A: $ ./leader_tutorial 3 1 0
    B: $ ./leader_tutorial 3 3 1
    C: $ ./leader_tutorial 3 0 2
